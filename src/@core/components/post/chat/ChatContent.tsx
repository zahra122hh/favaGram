...
import ChatLog from 'src/@core/components/post/chat/ChatLog'
import SendMsgForm from 'src/@core/components/post/chat/SendMsgForm'
import CustomAvatar from 'src/@core/components/mui/avatar'
import OptionsMenu from 'src/@core/components/option-menu'
import UserProfileRight from 'src/@core/components/post/chat/UserProfileRight'
